 ...
 * **Definição**:Apresentado o progresso das tarefas por cada membro da equipe:
    ...
    * **Nathan**: Corrigiu os problemas da issue da semana anterior e finalizou a mesma. Adicionou estudos sobre persistencia e testes unitarios do frontend
    * **João**: Implementou o tutorial no frontend
    * **Tiago**: Implementou o sistema de mineração do G1
