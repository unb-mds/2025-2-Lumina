...
* `[João e Arthur]`: Fazer o prototipo de baixa fidelidade.

* `[João]`: Criar um esboço no figma para entender como ele funciona.

* `[Tiago e Arthur]`: Refatorar o documento de requisitos para alinhar melhor com o escopo do projeto.

* `[Arthur]`: Criar o story map.

* `[Tiago]`: Definir arquitetura e documentar ela.

* `[Átila]`: Refatorar o gitpages e deixar funcionando certinho.

* `[Nathan]`: Adicionar os Padrões de Software Livre.

* `[Cecília, Arthur e Tiago]`: Atualizar o Figma.

* `[Cecília]`: Retificar o backlog das sprints.

* `[Cecília]`: Documentar Sprints.
